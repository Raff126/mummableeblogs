...
const PUBLIC_FILE_PATH = path.join(process.cwd(), 'public', 'data', 'homepage.json');
...
function writeToFile(content: HomepageContent): boolean {
  try {
    ...
    // Also write to public/data/homepage.json so static export includes it
